...
const App = () => { 
    ...
    const [expandedPracticeClass, setExpandedPracticeClass] = useState(null); // Practice Accordion State
            ...
            {showNameModal && ( 
                <div className="fixed inset-0 bg-black/90 z-[1000] flex items-center justify-center p-6 backdrop-blur-md print:hidden"> 
                    <div className="bg-slate-900 rounded-3xl p-8 max-w-sm w-full text-center shadow-2xl border-2 border-slate-800"> 
                        ...
                        {currentExam?.isGuestEnabled && ( <p className="text-[10px] font-black text-red-500 mb-6 uppercase italic leading-tight animate-pulse"> * REGISTERED STUDENTS MUST ENTER THEIR UNIQUE CODE TO GENERATE A PERFORMANCE TRANSCRIPT IN THE GROWTH SECTION. </p> )} 
