...
const TeacherZoneMainView = ({ liveMocks, practiceSets, students, teacherPin, setTeacherPin, studentResults }) => {
  ...
  // Logic to separate Admin items for POINT 1
  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <PaperManager title="Live Mock Exam" items={adminLive} type="live" color="text-red-500" />
      <PaperManager title="Practice Sets" items={adminShifted} type="practice" color="text-blue-400" />
